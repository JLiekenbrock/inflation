...
Because of the correlation patterns observed in the group report i got motivated to look into this.
Since i was already done with my report otherwise but i still want to show the result i will keep things short here.
...
The target group of this visualisation is far more narrow as it uses more advanced techniques which might not be clear to the general public. It also not understandable on the first look for sure.

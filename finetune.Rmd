...
#### Finding a topic
The first step was finding an intereisting topic. Our group was united in that we wanted to look at data which is currently relevant. Because of the war in Ukraine (and other factors) inflation is a current topic. 
...
I decided to use the monthly data as it is the most fine grained dataset. 
...
Because i have now timeseries of four inflation types by regions i was certain i want to do a small multiples plot.
...
data = data%>%
  ...
  filter(date>=as.POSIXct("20060101",format="%Y%m%d"))
